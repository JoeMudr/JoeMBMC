...
void BMSModuleManager::balanceCells(int debug)
{
  ...
  for (int y = 1; y < 63; y++){
    if (modules[y].isExisting() == 1){
      ...
      for (int i = 0; i < 8; i++){
        if (bitRead(balance, i) == 1){OUTmsg.buf[i] = 0x08;}
        else{OUTmsg.buf[i] = 0x00;}
      }
      switch (y){
        case (1): OUTmsg.id  = 0x1A55540A; break;
        case (2): OUTmsg.id  = 0x1A55540C; break;
        case (3): OUTmsg.id  = 0x1A55540E; break;
        case (4): OUTmsg.id  = 0x1A555410; break;
        case (5): OUTmsg.id  = 0x1A555412; break;
        case (6): OUTmsg.id  = 0x1A555414; break;
        case (7): OUTmsg.id  = 0x1A555416; break;
        case (8): OUTmsg.id  = 0x1A555418; break;
        default:
          return;
          break;
      }
      ...
      switch (y)
      {
        case (1): OUTmsg.id  = 0x1A55540B; break;
        case (2): OUTmsg.id  = 0x1A55540D; break;
        case (3): OUTmsg.id  = 0x1A55540F; break;
        case (4): OUTmsg.id  = 0x1A555411; break;
        case (5): OUTmsg.id  = 0x1A555413; break;
        case (6): OUTmsg.id  = 0x1A555415; break;
        case (7): OUTmsg.id  = 0x1A555417; break;
        case (8): OUTmsg.id  = 0x1A555419; break;
...
void BMSModuleManager::decodetemp(CAN_message_t &msg, int debug){
  ...
  if (CMU > 10 && CMU < 60){CMU = (CMU * 0.5) - 15;}
  /*
    if (CMU > 64 && CMU < 73)
    {
    CMU = CMU - 48;
...
void BMSModuleManager::decodecan(CAN_message_t &msg, int debug){
  ...
  switch (msg.id){
    /*
      ...
      case (0x210): CMU = 25; Id = 0; break;
      case (0x211): CMU = 25; Id = 1; break;
      case (0x212): CMU = 25; Id = 2; break;
      case (0x214): CMU = 26; Id = 0; break;
      case (0x215): CMU = 26; Id = 1; break;
      case (0x216): CMU = 26; Id = 2; break;
      case (0x218): CMU = 27; Id = 0; break;
      case (0x219): CMU = 27; Id = 1; break;
      case (0x21A): CMU = 27; Id = 2; break;
      case (0x21C): CMU = 28; Id = 0; break;
      case (0x21D): CMU = 28; Id = 1; break;
      case (0x21E): CMU = 28; Id = 2; break;
      case (0x220): CMU = 29; Id = 0; break;
      case (0x221): CMU = 29; Id = 1; break;
      case (0x222): CMU = 29; Id = 2; break;
      case (0x224): CMU = 30; Id = 0; break;
      case (0x225): CMU = 30; Id = 1; break;
      case (0x226): CMU = 30; Id = 2; break;
      case (0x228): CMU = 31; Id = 0; break;
      case (0x229): CMU = 31; Id = 1; break;
      case (0x22A): CMU = 31; Id = 2; break;
      case (0x22C): CMU = 32; Id = 0; break;
      case (0x22D): CMU = 32; Id = 1; break;
      case (0x22E): CMU = 32; Id = 2; break;

      ///////////////// Two extender increment//////////
      case (0x1F0): CMU = 17; Id = 0; break;
      case (0x1F1): CMU = 17; Id = 1; break;
      case (0x1F2): CMU = 17; Id = 2; break;
      case (0x1F4): CMU = 18; Id = 0; break;
      case (0x1F5): CMU = 18; Id = 1; break;
      case (0x1F6): CMU = 18; Id = 2; break;
      case (0x1F8): CMU = 19; Id = 0; break;
      case (0x1F9): CMU = 19; Id = 1; break;
      case (0x1FA): CMU = 19; Id = 2; break;
      case (0x1FC): CMU = 20; Id = 0; break;
      case (0x1FD): CMU = 20; Id = 1; break;
      case (0x1FE): CMU = 20; Id = 2; break;
      case (0x200): CMU = 21; Id = 0; break;
      case (0x201): CMU = 21; Id = 1; break;
      case (0x202): CMU = 21; Id = 2; break;
      case (0x204): CMU = 22; Id = 0; break;
      case (0x205): CMU = 22; Id = 1; break;
      case (0x206): CMU = 22; Id = 2; break;
      case (0x208): CMU = 23; Id = 0; break;
      case (0x209): CMU = 23; Id = 1; break;
      case (0x20A): CMU = 23; Id = 2; break;
      case (0x20C): CMU = 24; Id = 0; break;
      case (0x20D): CMU = 24; Id = 1; break;
      case (0x20E): CMU = 24; Id = 2; break;
    */
